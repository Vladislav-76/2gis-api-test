...
CORRECT_LOCATION_LATS = (90, 0, -90, 89.999999, -89.999999)
INCORRECT_LOCATION_LATS = (
    90.000001, -90.000001, 90.00000000000001, -90.00000000000001, "lat", None, [51, 55], {"lat": 51}
)
CORRECT_LOCATION_LONS = (180, 0, -180, 179.999999, -179.999999)
INCORRECT_LOCATION_LONS = (
    180.000001, -180.000001, 180.0000000000001, -180.0000000000001, "lon", None, [51, 55], {"lon": 51}
)
CORRECT_LOCATION_COLORS = ("BLUE", "GREEN", "RED", "YELLOW", None)
INCORRECT_LOCATION_COLORS = (
    "blue", "BLUEstarts", "endsBLUE", "BLACK", 6, ["BLUE", "GREEN"], {"BLUE": "GREEN"}
)
